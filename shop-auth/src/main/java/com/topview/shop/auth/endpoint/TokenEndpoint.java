package com.topview.shop.auth.endpoint;
...
import com.topview.shop.admin.api.vo.TokenVo;
...
import com.topview.shop.common.security.util.OAuth2EndpointUtils;
...
public class TokenEndpoint {
	...
	@Inner
	@PostMapping("/page")
	public CommonResult<Page> tokenList(@RequestBody Map<String, Object> params) {
		// 根据分页参数获取对应数据
