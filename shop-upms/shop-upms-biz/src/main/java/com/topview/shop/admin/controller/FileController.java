...
import com.topview.shop.admin.service.SysFileService;
...
public class FileController {
	...
	public CommonResult<IPage<SysFile>> getSysFilePage(Page page, SysFile sysFile) {
		return CommonResult.ok(sysFileService.page(page, Wrappers.<SysFile>lambdaQuery()
	...
	public CommonResult<Boolean> removeById(@PathVariable Long id) {
		return CommonResult.ok(sysFileService.deleteFile(id));
	}
	...
	public CommonResult<String> onlineFile(@PathVariable String bucket, @PathVariable String fileName) {
		return CommonResult.ok(sysFileService.onlineFile(bucket, fileName));
	}
