...
public class OauthClientDetailsController {
	...
	public CommonResult<List<SysOauthClientDetails>> getByClientId(@PathVariable String clientId) {
		return CommonResult.ok(sysOauthClientDetailsService
	 ...
	 */
	@GetMapping("/page")
	public CommonResult<IPage<SysOauthClientDetails>> getOauthClientDetailsPage(Page page,
			SysOauthClientDetails sysOauthClientDetails) {
		return CommonResult.ok(sysOauthClientDetailsService.page(page, Wrappers.query(sysOauthClientDetails)));
	}
	...
	public CommonResult<Boolean> add(@Valid @RequestBody SysOauthClientDetails sysOauthClientDetails) {
		return CommonResult.ok(sysOauthClientDetailsService.save(sysOauthClientDetails));
	}
	...
	public CommonResult<Boolean> removeById(@PathVariable String id) {
		return CommonResult.ok(sysOauthClientDetailsService.removeClientDetailsById(id));
	}
	...
	public CommonResult<Boolean> update(@Valid @RequestBody SysOauthClientDetails sysOauthClientDetails) {
		return CommonResult.ok(sysOauthClientDetailsService.updateClientDetailsById(sysOauthClientDetails));
	}
	...
	public CommonResult getClientDetailsById(@PathVariable String clientId) {
		System.out.println("客户端id是：--------------" + clientId);
